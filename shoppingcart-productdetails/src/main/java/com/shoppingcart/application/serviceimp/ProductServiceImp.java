...
import com.productdetails.application.exception.ProductServiceCustomException;
...
public class ProductServiceImp implements ProductService{
	...
	public void reduceQuantity(long productId, long quantity) {
		...
		if(product.getQuantity()<quantity) {
			throw new com.productdetails.application.exception.ProductServiceCustomException("Product does not have sufficent quantity","INSUFFICIENT_QUANTITY");
		}
	...
	public void deleteProductById(long productId) {
		...
		{
			throw new com.productdetails.application.exception.ProductServiceCustomException("Product with given Id:"+productId+"not found","PRODUCTT_NOT_fOUND");
		}
